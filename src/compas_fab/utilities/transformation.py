...
def from_t0cf_to_tcf(t0cf_frame_in_wcf, tool_coordinate_frame):
    ...
    Let: T0CF_TCF = tool_coordinate_frame
    Let: frames in TCF relative to WCF = W_TCF
    Then: W_TCF = W_T0CF * T0CF_TCF
    ...
    """
    W_T0CF = Transformation.from_frame(t0cf_frame_in_wcf)
    T0CF_TCF = Transformation.from_frame(tool_coordinate_frame)
    W_TCF = W_T0CF * T0CF_TCF
    return Frame.from_transformation(W_TCF)
