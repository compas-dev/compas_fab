...
from compas_fab.robots import FrameInterpolator
from compas_fab.robots import FrameTarget
from compas_fab.robots import FrameWaypoints
from compas_fab.robots import JointTrajectory
from compas_fab.robots import JointTrajectoryPoint
from compas_fab.robots import PointAxisInterpolator
...
class PyBulletPlanCartesianMotion(PlanCartesianMotion):
    ...
    def plan_cartesian_motion_point_axis_waypoints(
        ...
        for i in range(len(waypoints.target_points_and_axes)):
            ...
            interpolator = PointAxisInterpolator(
                start_point_axis,
                end_point_axis,
                max_step_distance=options["max_step_distance"],
                max_step_angle=options["max_step_angle"],
            )
    ...
    def plan_cartesian_motion_frame_waypoints(
        ...
        for i in range(len(waypoints.target_frames)):
            ...
            interpolator = FrameInterpolator(
                ...
                max_step_distance=options["max_step_distance"],
                max_step_angle=options["max_step_angle"],
                min_step_distance=options["min_step_distance"],
                min_step_angle=options["min_step_angle"],
            )
