...
The ``ReachabilityMap`` describes the reachability of a robot by discretizing
its environment, i.e. by defined frames with valid IK solutions at these frames.
