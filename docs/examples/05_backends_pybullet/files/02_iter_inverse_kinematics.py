...
with PyBulletClient(connection_type='direct') as client:
    ...
    try:
        # Notice that Pybullet will often return less than the max_results specified
        options = dict(max_results=20, high_accuracy_threshold=1e-6, high_accuracy_max_iter=300)
