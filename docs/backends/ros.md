...
- [`08_motion_plan_pick_and_place.py`](https://github.com/compas-dev/compas_fab/blob/main/docs/backends/ros/files/08_motion_plan_pick_and_place.py) — assembling several trajectories + state changes into a serializable `MotionPlan` (see [Concepts](../concepts.md#assembling-multi-stage-motions))
